      ...
      <div>
        <div className="space-y-8 p-10">
          <h1 className="text-5xl font-bold max-w-2xl leading-[110%] relative z-10">
            ...
            <Link
              href="mailto:shivangmdev@gmail.com"
              className="text-red-600 hover:text-primary/80 border-b-2 border-red-500 hover:border-primary/80 transition-colors duration-200"
            >
              via email
            </Link>{" "}
            to collaborate!
          ...
          <ShinyButton>
            <Link href="mailto:shivangmdev@gmail.com">Schedule call</Link>
          </ShinyButton>
        </div>
        ...
        <div className="mt-16 p-10 border-t border-dark-200 dark:border-white/10 flex flex-col md:flex-row justify-between gap-10 md:gap-0">
          <div className="space-y-2.5">
            ...
            © {new Date().getFullYear()} Shivang Mandal. All rights reserved.
            </p>
          </div>
          ...
          <div className="flex justify-between gap-0 sm:gap-16">
            ...
            <ul className="space-y-2.5 relative z-10 text-sm sm:text-base">
              ...
              <li className="text-dark-200/60 hover:text-dark-200 dark:text-white/50 dark:hover:text-white">
                <Link
                  href="https://linkedin.com/in/shivang-mandal-dev"
                  target="_blank"
                >
                  LinkedIn
                </Link>
              ...
              <li className="text-dark-200/60 hover:text-dark-200 dark:text-white/50 dark:hover:text-white">
                <Link href="https://github.com/ShivangM-Dev" target="_blank">
                  Github
                </Link>
              </li>
              <li className="text-dark-200/60 hover:text-dark-200 dark:text-white/50 dark:hover:text-white">
                <Link 
                href="https://www.instagram.com/shivang_mandal_dev/?hl=en"
                target="_blank"
                >
                  Instagram</Link>
              </li>
